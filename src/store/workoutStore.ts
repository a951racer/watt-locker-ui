...
export interface WorkoutState {
  ...
  updateWorkout: (id: string, updates: { title?: string; tags?: string[]; comment?: string }) => Promise<void>;
...
export const useWorkoutStore = create<WorkoutState>((set, get) => ({
  ...
  updateWorkout: async (id: string, updates: { title?: string; tags?: string[]; comment?: string }) => {
    try {
